...
<head>
<style>
body{background-image:url("city.jpg");font-family: 'Zhi Mang Xing',cursive;font-size:40px;}
</style>
</head>
<body>
<p align="center">Hello you on site where can be fount kompaniy</p>
<link href="https://fonts.googleapis.com/css?family=Zhi+Mang+Xing&display=swap" rel="stylesheet">
<p><img src="sam.jpg"width="250px"></p>
Samsung є чим пишатися: корейська компанія не раз ставала новатором, випереджаючи інших технологічних гігантів, включаючи Apple.

На початку шляху Samsung продавала продукти харчування і навіть текстиль. Хто б міг подумати, що до кінця століття компанія стане передовим виробником електроніки? В історії Samsung є багато інших цікавих фактів. Закривай Google, ми вже зібрали двадцятку найцікавіших.

1. У перекладі з корейської “Samsung” означає «три зірки»
<p><img src="apl.jpg"width="250px"></p>
...
<p><img src="mi.png"width="250px"></p><html>
Xiaomi стартувала саме як Інтернет-компанія без виробничих потужностей, смартфонів, планшетів та інших фізичних продуктів. Xiaomi створила оболонку MIUI і просувала її в магазині Android, коли фанатів MIUI по всьому світу стало достатньо - компанія взялася за виробництво своїх смартфонів.

2 Факт другий: Xiaomi робить ноутбук


Поки ринок смартфонів повільно рухається до точки рівноваги, китайська Xiaomi шукає для себе нові напрямки. Компанія Inventec, яка збирає ноутбуки, офіційно підтвердила той факт, що Xiaomi готує свій ноутбук, запуск відбудеться вже в 2016 році.

3 Факт третій: Xiaomi в Книзі Рекордів Гіннесса

<p><img src="hua.png"width="250px"></p><html>
